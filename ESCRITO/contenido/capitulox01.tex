...
El problema que se aborda en el presente trabajo presenta diversos estudios en la literatura, a pesar de esto siguen siendo un desafío computacional. Entre los últimos estudios relacionados existen algunos que utilizan Programación Genética mostrando las bondades de las heurísticas al aplicarlas sobre las NN, a pesar de esto, no existen nuevo estudios que utilizen otras técnicas heurísticas para dar solución al problema que presenta la actualización de los pesos en el entrenamiento de las NN.

Para el desarrollo de este estudio se analiza la convergencia de una NN al entrenarla utilizando un método heurístico para minimizar el error. Para el desarrollo de éstos, surgen algunas preguntas que permitirían evaluar el desempeño del método: ¿La convergencia ofrecida por el método heurístico ofrece un mejor desempeño respecto a métodos tradicionales?
...
El método de aprendizaje basado en simmulated annealing permite la actualización de los pesos de la red. El método supone una alternativa efectiva a los métodos tradicionales de aprendizaje para la convergencia de los métodos debido a la independencia que otorga a la actualización de los pesos de las distintas capas.
