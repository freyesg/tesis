...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%% lista3
Aunque DL tiene buena reputación para resolver una variación de la tarea de aprendizaje, no es fácil entrenar [3]. La reciente propuesta de técnicas de optimización para la formación DL ha utilizado capas de pre-entrenamiento preestablecido [4]. Algunos ejemplos de los métodos exitosos para el entrenamiento de esta técnica son Descenso de Gradiente Estocástico, Gradiente de Conjugado, Optimización de Hessian-free y Descenso de Subespacio de Krylov.

El Descenso de Gradiente Estocástico (SGD) es sencillo de implementar y también rápido en el proceso de problemas que tienen muchos ejemplos de entrenamiento. Sin embargo, este método necesita muchas afinaciones manuales para optimizar sus parámetros y secuenciales esenciales, por lo que es difícil distribuirlos utilizando clusters de computadoras o paralelizarlos usando GPUs. Por el contrario, Conjugate Gradient (CG) puede distribuir el cálculo entre máquinas y paralelizar para calcular el gradiente en la GPU, así como más estable para entrenar y más fácil de comprobar la convergencia. Pero este método suele ser lento y puede ser rápido debido a la disponibilidad de grandes cantidades de RAM, CPU multicore, GPU y clúster de equipos con hardware de red rápido [5].
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
