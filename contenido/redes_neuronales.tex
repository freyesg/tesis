...
Si se tiene una NN, la activación de una neurona de una capa intermedia $i$ con función de activación $f_i$ y con entrada $net_{i}(t) = \sum_{j}w_{ij}y^{j}(t - 1)$ es $y^{i}(t) = f_{i}(net_{i}(t))$
