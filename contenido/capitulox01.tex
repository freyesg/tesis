...
Para que las direcciones de descenso permanezcan verdaderamente conjugadas, la búsqueda unidirecional, en cada iteración, tiene que ser llevada con alta precisión. Sin embargo, después de muchas iteraciones, las direcciones podrían llegar a ser casi paralelas; Para superar esta dificultad, Tletcher y Reeves (1964) sugirieron reiniciar el procedimiento igualando la dirección de descenso al gradiente en cada iteración (t + 1), donde (t) es el número total de pesos en la red.
